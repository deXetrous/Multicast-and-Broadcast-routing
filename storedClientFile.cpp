...
void play()
{
    ...
    while(true)
    {
        if(sharedAdr == 1)
        {
            ...
            if(sharedIndex == 1)
                m = libvlc_media_new_path(inst, "/home/harshit/Documents/NetworksProg/Project/demo1.mp3");
            else
            {
            ...
            unsigned int microseconds = 12000;
            usleep(microseconds);
    ...
    while(true)
    {
        ...
        if(index % 5 == 0)
        {
            ...
            if(index%10 == 0)
            {
                ...
                fp.open("demo1.mp3", ios::binary | ios::out);
            }
            else
            {
                fp.open("demo12.mp3", ios::binary | ios::out);
            }
        }
